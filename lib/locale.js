...
exports.localization = {
  ...
  // masternode view
  "mn_title": "{1} Gamemasters",
  "mn_description": "A listing of all gamemasters known to be active on the {1} network",
  "mn_masternode_list": "Gamemaster List",
  ...
  "api_getgamemasterlist": "Returns the complete list of gamemasters on the network.",
  "api_getgamemastercount": "Returns the total number of gamemasters on the network.",
