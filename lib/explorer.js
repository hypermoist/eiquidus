...
module.exports = {
  ...
  get_masternodelist: function(cb) {
    var cmd = prepareRpcCommand(settings.api_cmds.getgamemasterlist);
    ...
    if (!(cmd.method == '' && cmd.parameters.length == 0)) {
      if (settings.api_cmds.use_rpc) {
        ...
        var uri = base_url + 'getgamemasterlist';
  ...
  get_masternodecount: function(cb) {
    ...
    if (settings.api_page.public_apis.rpc.getgamemastercount.enabled == true && settings.api_cmds['getgamemastercount'] != null && settings.api_cmds['getgamemastercount'] != '') {
      var cmd = prepareRpcCommand(settings.api_cmds.getgamemastercount);
      ...
      if (!(cmd.method == '' && cmd.parameters.length == 0)) {
        if (settings.api_cmds.use_rpc) {
          ...
          var uri = base_url + 'getgamemastercount';
