...
exports.loadSettings = function loadSettings() {
  ...
  if (json_settings != null) {
    ...
    json_settings = fix_deprecated_setting(json_settings, 'public_api.rpc.getgamemastercount', 'api_page.public_apis.rpc.getgamemastercount.enabled');
    ...
    json_settings = fix_deprecated_setting(json_settings, 'public_api.ext.getgamemasterlist', 'api_page.public_apis.ext.getgamemasterlist.enabled');
    json_settings = fix_deprecated_setting(json_settings, 'public_api.ext.getgamemasterrewards', 'api_page.public_apis.ext.getgamemasterrewards.enabled');
    json_settings = fix_deprecated_setting(json_settings, 'public_api.ext.getgamemasterrewardstotal', 'api_page.public_apis.ext.getgamemasterrewardstotal.enabled');
    ...
    json_settings = fix_deprecated_setting(json_settings, 'api_cmds.gamemaster_count', 'api_cmds.getgamemastercount');
